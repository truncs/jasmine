...
def preprocess_npz(input_dir, original_fps,
    ...
    try:
        ...
        for fname in selected_files:
            ...
            obs_chunks.extend(obs_current_chunk.expand_dims(axis=0))
            act_chunks.extend(act_current_chunk.expand_dims(axis=0))
            reward_chunks.extend(reward_current_chunk.expand_dims(axis=0))
